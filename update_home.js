...
function PageSkeleton() {
  return (
    <div style={{ padding: "40px", width: "100%", maxWidth: 1400, margin: "0 auto" }}>
              ...
              <div style={{ height: 250, width: "100%" }}>
                <ResponsiveContainer width="100%" height="100%">
                  <RechartsPieChart>
                    ...
                    <Tooltip 
                      formatter={(value: number) => [formatRupiah(value), "Total Spend"]}
              ...
              <div style={{ height: 250, width: "100%" }}>
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={savingsData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                    ...
                    <Tooltip 
                      formatter={(value: number) => [formatRupiah(value), "Savings"]}
